(function(){
    ...
    document.getElementById("backstory-arrow").addEventListener('click', function (event) {
        event.preventDefault();
    ...
    document.getElementById("prev2").addEventListener("click", function(){showSlides(1, slideIndex[1] -= 1);});
    document.getElementById("next2").addEventListener("click", function(){showSlides(1, slideIndex[1] += 1);});

    document.getElementById("prev3").addEventListener("click", function(){showSlides(2, slideIndex[2] -= 1);});
    document.getElementById("next3").addEventListener("click", function(){showSlides(2, slideIndex[2] += 1);});

    document.getElementById("prev4").addEventListener("click", function(){showSlides(3, slideIndex[3] -= 1);});
    document.getElementById("next4").addEventListener("click", function(){showSlides(3, slideIndex[3] += 1);});

    document.getElementById("prev5").addEventListener("click", function(){showSlides(4, slideIndex[4] -= 1);});
    document.getElementById("next5").addEventListener("click", function(){showSlides(4, slideIndex[4] += 1);});

    document.getElementById("prev6").addEventListener("click", function(){showSlides(5, slideIndex[5] -= 1);});
    document.getElementById("next6").addEventListener("click", function(){showSlides(5, slideIndex[5] += 1);});
